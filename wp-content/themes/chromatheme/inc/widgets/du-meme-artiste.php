<?php
if (!class_exists('du-meme-artiste')) :
    /**
     * Adds du-meme-artiste widget.
     */
    class du-meme-artiste extends AFthemes_Widget_Base
    {
        /**
        ...
        function __construct()
        {
            ...
            $widget_ops = array(
                'classname' => 'du-meme-artiste_widget',
                'description' => __('Displays posts slider from selected category.', 'covernews'),
                'customize_selective_refresh' => true,
            );

            parent::__construct('du-meme-artiste', __('CoverNews Posts Slider', 'covernews'), $widget_ops);
        }
