<?php
if (!class_exists('CoverNews_Meme_Artiste')) :
    /**
     * Adds CoverNews_Meme_Artiste widget.
     */
    class CoverNews_Meme_Artiste extends AFthemes_Widget_Base
    {
        /**
        ...
        function __construct()
        {
            ...
            $widget_ops = array(
                'classname' => 'CoverNews_Meme_Artiste_widget',
                'description' => __('Coucou.', 'covernews'),
                'customize_selective_refresh' => true,
            );

            parent::__construct('CoverNews_Meme_Artiste', __('Meme Artiste', 'covernews'), $widget_ops);
        }
